...
namespace depth {
  ...
  struct Opts {
    ...
    Opts& useInflater(InflaterRef inflaterRef);
  };
  ...
  // bit-size conversion
  void convert_32bit_to_8bit(size_t size, const void* data, void* target);
  void convert_16bit_to_8bit(size_t size, const void* data, void* target);
  ...
  // FrameRef convert_8bit_to_16bit(size_t amount, const void* data);
  // FrameRef convert_to_16bit(const void* data, size_t size);
